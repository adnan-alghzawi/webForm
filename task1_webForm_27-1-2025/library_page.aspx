  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="https://localhost:44386/page1.aspx">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="https://localhost:44386/profile.aspx">Profile</a>
        </li>
